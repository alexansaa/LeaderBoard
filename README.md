...
**Leader Board** is a HTML, CSS and JavaScript project that displays a friendly interface for tracking scores in a dynamic table. This project is meant to be a support for your leader scores tracking and visualization. The leader borad information is taken from an API in the web.
...
- [Live Demo!](https://alexansaa.github.io/LeaderBoard/)
...
Feel free to check the [issues page](https://github.com/alexansaa/LeaderBoard/issues).
